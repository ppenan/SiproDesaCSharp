...
export class DialogOverviewSubProductoTipo {
  constructor(public dialog: MatDialog) {}
}

@Component({
  selector: 'modal-subproducto-tipo.ts',
  templateUrl: './modal-dialog.html'
})
export class DialogSubProductoTipo {
  ...
  constructor(public dialog: MatDialog,
    public dialogRef: MatDialogRef<DialogSubProductoTipo>,
